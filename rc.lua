...
beautiful.init("/home/vladislav/.config/awesome/themes/zenburn/theme.lua")


theme.wallpaper_cmd = ("awsetbg-f /home/vladislav/.config/awesome/themes/back.png")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "|all|", "|console|", "|edit|", "|test|", "|php|","|qt|", "|internet|", "|fun|" }, s, layouts[1])
end
-- }}}
--floatapps =
--{
...
--apptags =
--{
--    ["google-chtome"]   = { screen = 1, tag = 5 }
--    ["qt-creator"]      = { screen = 1, tag = 4 }
--
--}
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
       ...
       --mylayoutbox[s],
	    ...
	    --udisks_glue.widget, separator,
        my_volume.widget,volume_label, separator,
...
-- AMixer
    ...
    awful.key({ modkey,           }, "q", function () awful.util.spawn("qtcreator")   end ),
    -- Layout manipulation
